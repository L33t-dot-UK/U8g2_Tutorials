 ...
 * 
 * The bird animation will play once and the dragon animation will loop. The bird animaiton will block the microcontroller
 * However the dragon animaiton will not.
 * 
...
void loop() {
    ...
    //The bird animation will block your micro controller which can be helpful in some cases. For instance
    //if you want a splash screen animation at startup this method could be used in the setup()
    //function or in the loop() funciton as shown below.
