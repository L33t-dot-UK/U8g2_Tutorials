...
int loopCnt = 0; //Counter used to time how long each loop iteration takes
void loop() {
    loopCnt = millis();
    increment_BIRD_animation(); //Call this function, this is done this way due to Arduino IDE issues
                                //Once we create and import a library we will do this a different way
    Serial.println(millis()-loopCnt); //Calculate loop time and print out
}
